module.exports = {
 ...
 run: async ({client, msg, args, author, MessageEmbed, uye, CezapuanDatabase, SetupDatabase}) => {
  ...
  await CezapuanDatabase.findOneAndUpdate({ guildID: msg.guild.id, userID: uye.id}, { $set: { cezapuanıban: 0, cezapuanıchatmute: 0, cezapuanıvoicemute: 0, cezapuanıjail: 0, cezaPuanTotal: 0 } }, { upsert: true });}}